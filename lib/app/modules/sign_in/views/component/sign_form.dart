...
class SignForm extends StatefulWidget {
  ...
  @override
  _SigFormState createState() => _SigFormState();
}

class _SigFormState extends State<SignForm> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const Spacer(),
              GestureDetector(
                onTap: () => Get.toNamed(Routes.FORGOT_PASSOWRD),
          ...
          DefaultButton(
            ...
            press: () {
              if (_formKey.currentState!.validate()) {
                ...
                Get.toNamed(Routes.LOGIN_SUCCESS);
              }
            },
          ),
          // Spacer(),
